...
import styles from "./mirt.module.scss";
  ...
  return (
    <div
      className={classNames(
        styles.mirt,
        {
          [styles["mirt--initialized"]]: initialized,
          [styles["mirt--disabled"]]: !initialized,
        },
        className
      )}
      style={style}
    >
      {config.showButton && (
        <button
          className={styles["mirt__play-button"]} // Correct way to reference styles from CSS Modules
          type="button"
        ...
        >
          {playing ? (
            <svg
              ...
              fill="currentColor"
              className={styles["mirt__play-button-icon"]}
            >
      ...
      <div className={styles["mirt__timeline"]}>
        <div className={styles["mirt__range-handles"]}>
          <div className={styles["mirt__range-handle-frame"]}>
            <input
              ref={start}
              className={`${styles["mirt__range-handle"]} ${styles["mirt__range-handle--start"]}`}
              type="range"
            ...
            <input
              ref={end}
              className={`${styles["mirt__range-handle"]} ${styles["mirt__range-handle--end"]}`}
              type="range"
              min={getMinValue(fineTuning, fineTuningResolution, duration)}
              max={getMaxValue(fineTuning, fineTuningResolution, duration)}
              value={endPosition}
          ...
          <div className={styles["mirt__range-handle-playhead-track"]}>
            <input
              ref={playhead}
              className={`${styles["mirt__range-handle"]} ${styles["mirt__range-handle--playhead"]}`}
              type="range"
              min={getMinValue(fineTuning, fineTuningResolution, duration)}
              max={getMaxValue(fineTuning, fineTuningResolution, duration)}
        ...
        <div className={styles["mirt__handles"]}>
          <div
            className={classNames(styles["mirt__handle-frame"], {
              [styles["mirt__handle-frame--start-dragging"]]: startDragging,
              [styles["mirt__handle-frame--end-dragging"]]: endDragging,
            })}
            style={{
          ...
          >
            <svg
              viewBox="0 0 16 32"
              xmlns="http://www.w3.org/2000/svg"
              className={`${styles["mirt__handle-icon"]} ${styles["mirt__handle-icon--start"]}`}
              fill="currentColor"
            >
            ...
            <svg
              viewBox="0 0 16 32"
              xmlns="http://www.w3.org/2000/svg"
              className={`${styles["mirt__handle-icon"]} ${styles["mirt__handle-icon--end"]}`}
              fill="currentColor"
            >
          ...
          <div className={styles["mirt__playhead-track"]}>
            <div
              className={classNames(styles["mirt__playhead"], {
                [styles["mirt__playhead--dragging"]]:
        ...
        {initialized && (
          <div className={styles["mirt__waveform"]}>
            <Waveform
              file={file}
