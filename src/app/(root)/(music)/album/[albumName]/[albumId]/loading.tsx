...
export default function HomePageSkeleton() {
  return (
    ...
    // <div className="text-white relative p-5 flex flex-col">
    //   <div className="  flex items-end pl-4 gap-5  ">
    //     <div className=" text-2xl text first-letter:capitalize Montserrat-bold pl-2 cursor-default">
    //       <Box
    //         sx={{
    //           width: 160, // Set the desired width
    //           aspectRatio: "1 / 1", // This ensures a square shape
    //         }}
    //       >
    //         <Skeleton
    //           sx={{ bgcolor: "grey.800" }}
    ...
    //     </div>
    //     <div className=" pb-10">
    //       <Skeleton sx={{ bgcolor: "grey.800" }} width={150} height={50} />
    //       <Skeleton sx={{ bgcolor: "grey.800" }} width={250} height={25} />
    //     </div>
    //   </div>
